...
class TestReportEntity:
    def test_valid_report_creation(self):
        ...
        assert report.email == "john.doe@example.com"
    ...
    def test_empty_complaint_raises_error(self):
        ...
        with pytest.raises(ValueError) as excinfo:
            Report(
                id="test-id", title="Valid Title", complaint="", report_type=report_type
            )
...
class TestUpdateReport:
    def test_update_report_method(self):
        ...
        assert report.email == "genesluna@gmail.com"
...
class TestEquality:
    ...
    def test_equality_different_classes(self):
        ...
        report_type = ReportType.DATA_LEAK
        category = Report(
            title="Test Report", complaint="Test Complaint", report_type=report_type
        )
        dummy = Dummy()
        dummy.id = common_id
